...
import com.oecbv.ixirus.ListAdapters.MessagesListAdapter;
import com.oecbv.ixirus.MessagesListItem;
...
public class MessagesActivity extends AppCompatActivity {
    ...
    public void loadListItem(final String savedToken) {
        lv.setAdapter(null);
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, "https://ixirus.azurewebsites.net/api/messages/list", null, new Response.Listener<JSONObject>() {
            @Override
